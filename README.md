...
- [Wizard-Engine](https://github.com/titzer/wizard-engine): Written in [Virgil](https://github.com/titzer/virgil), doesn't support the [threads proposal](https://github.com/WebAssembly/threads/blob/main/proposals/threads/Overview.md), but aims to be easy to grasp making it a good inspiration for Wasm binary processing.

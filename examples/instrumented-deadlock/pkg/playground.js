 ...
 * @param {number} ptr
 */
__exports.worker_entry_point = function(ptr) {
    const ret = wasm.worker_entry_point(ptr);
    if (ret[1]) {
 ...
 */
__exports.create_deadlock = function() {
    const ret = wasm.create_deadlock();
    return ret;
};

__exports.lock_hook = function() {
    wasm.lock_hook();
};
...
function __wbg_get_imports() {
    const imports = {};
    imports.wbg = {};
    imports.wbg.__wbg_log_d41d1289a1625c80 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_log_477f6d1023270505 = typeof console.log == 'function' ? console.log : notDefined('console.log');

...
"i32_atomic_rmw_sub": function (func, instr, offset, align, addr, value, read) {
    Wasabi.analysis.atomic_rmw({func, instr}, "i32.atomic.rmw.sub", {addr, offset, align}, value, read);
},
"i32_atomic_rmw_cmpxchg": function (func, instr, offset, align, addr, expected, replacement, loaded) {
    Wasabi.analysis.atomic_cmpxchg({func, instr}, "i32.atomic.rmw.cmpxchg", {addr, offset, align}, expected, replacement, loaded);
},
"i32_atomic_rmw_xchg": function (func, instr, offset, align, addr, value, read) {
    Wasabi.analysis.atomic_rmw({func, instr}, "i32.atomic.rmw.xchg", {addr, offset, align}, value, read);
},
"memory_atomic_notify": function (func, instr, offset, align, addr, count, woken) {
    Wasabi.analysis.notify({func, instr}, "memory.atomic.notify", {addr, offset, align}, count, woken);
},
"i64_atomic_rmw_cmpxchg": function (func, instr, offset, align, addr, expected, replacement, loaded) {
    Wasabi.analysis.atomic_cmpxchg({func, instr}, "i64.atomic.rmw.cmpxchg", {addr, offset, align}, expected, replacement, loaded);
},
"memory_atomic_wait32": function (func, instr, offset, align, addr, expected, timeout) {
    Wasabi.analysis.wait({func, instr}, "memory.atomic.wait32", {addr, offset, align}, expected, timeout);
},
"i32_atomic_rmw_add": function (func, instr, offset, align, addr, value, read) {
    Wasabi.analysis.atomic_rmw({func, instr}, "i32.atomic.rmw.add", {addr, offset, align}, value, read);
},
"i32_atomic_store": function (func, instr, offset, align, addr, value) {
    Wasabi.analysis.atomic_store({func, instr}, "i32.atomic.store", {addr, offset, align}, value);
},
"i32_atomic_store8": function (func, instr, offset, align, addr, value) {
    Wasabi.analysis.atomic_store({func, instr}, "i32.atomic.store8", {addr, offset, align}, value);
},
};
